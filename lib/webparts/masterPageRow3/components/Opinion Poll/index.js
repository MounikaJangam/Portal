...
var Opinionpoll = function (props) {
    ...
    var _b = React.useState(true), setFormmode = _b[1];
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement("div", { className: 'inCard1 bg-gradient-one' },
            ...
            React.createElement("div", { className: 'row32 inCard--body' },
            ...
            React.createElement("div", { className: 'inCard1--Footer1' },
                React.createElement("button", { className: 'Footer1-Button-One' }, "View All")))));
};
